...
namespace ConnectExample.Samples
{
    ...
    public class SearchForImagesPagingSample
    {
        ...
        public SearchForImagesResponse Search(string token, int page)
        {
            ...
            var searchForImagesRequest = new SearchForImagesRequest
            {
                ...
                SearchForImages2RequestBody = new SearchForImages2RequestBody
                {
                    ...
                    ResultOptions = new ResultOptions { ItemCount = itemCount, ItemStartNumber = itemStartNumber }
                }
            };
        ...
        private static int PageStart(int page, int size)
        {
