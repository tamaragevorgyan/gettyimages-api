...
| *Urls*.Comp                                       | String      | Identifies the URL of the video, sized for layout composition. Comp videos are watermarked and larger than preview and thumbnail, but not full-sized. We do not have non-watermarked comp videos at this time. | 
