...
| _Status_.Code    | String      | Identifies the category of the status notification. See [Status Codes][/connect/documentation/appendix/StatusCodes.md] for an explanations of the codes.        |
